  ...
  if (!!user.id) {
    return (
      <div className='home-page'>
        ...
        <iframe className="embed-vid" src="https://www.youtube.com/embed/rg6CiPI6h2g"/>
    ...
    return (
      <div className='home-page-logout'>
        <h1>Welcome to the Mini Pokedex!</h1>
         <iframe className="embed-vid" src="https://www.youtube.com/embed/rg6CiPI6h2g"/>
        <h3>Please <a className="direct-profile" onClick={handleLoginClick} style={{color: "red", fontSize: 20, margin: 0}}>Log-In</a> or <a className="direct-profile" onClick={handleSignupClick} style={{color: "red", fontSize: 20}}>Sign-Up</a> First</h3>
